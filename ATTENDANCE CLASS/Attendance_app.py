...
class_codes = ["Computer Science"]
manager_id = "admin"
manager_pass = "admin"

current_class = "Computer Science"
if current_class != "Computer Science":
...
class SampleApp(tk.Tk):
    ...
    def createInitialDirectories(self):
        ...
        try:
            ...
            class_codes = set(["Computer Science"])
        ...
        if id == manager_id and pwd == manager_pass and c_code in class_codes:
            ...
            if current_class != "Computer Science":
                ...
                if page_name == "ManagerPanelPage":
                    ...
                    current_class_obj = MainFile(current_class)
            elif current_class == "Computer Science" and page_name == "StudentPanelPage":
